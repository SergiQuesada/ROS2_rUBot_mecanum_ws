...
class WallFollower(Node):
    ...
    def laser_callback(self, scan):
        ...
        #----------------------------------------------------------
        if min_front < self.base_distance and min_front < min_right and min_front < min_left:
        ...
        #----------------------------------------------------------
        # RULE 6: FRONT-LEFT obstacle -> move front-right
        #----------------------------------------------------------    
        ...
        #------------------------------------------------------------------------
        # RULE 7: LEFT visible -> move forward and maintain parallel (no angular)
        #------------------------------------------------------------------------
            ...
            twist.linear.x = self.v_lin
            twist.linear.y = vy
            action = f"LEFT {min_left:.2f} -> FORWARD (vy={vy:.2f})"

        #----------------------------------------------------------
        # RULE 8: BACK-LEFT -> move front-left
        #----------------------------------------------------------  
